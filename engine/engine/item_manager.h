...
public:
	...
	bool asociateTargetNeedle(XMVECTOR pos, float radius, CHandle grandma, float max_dist_reach_needle);
	bool getTargetNeedle(float radius, float max_dist_reach_needle);

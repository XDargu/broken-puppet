#ifndef INC_COLLISION_CONVEX_H_
#define INC_COLLISION_CONVEX_H_
...
class CCollision_Convex
{
	...
	static const CCollision_Convex*    convex_collision;
...
public:
	...
	physx::PxConvexMesh* collision_convex;
	//------------------------------------------------------------------
...
typedef CItemsByName< CCollision_Convex > CConvexCollisionManager;
extern CConvexCollisionManager convex_collision_manager;
extern CCollision_Convex convex_collision;

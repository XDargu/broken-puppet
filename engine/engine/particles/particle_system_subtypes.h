...
public:
	...
	//PhysX
	CPhysicsParticleSystem physXParticles;
...
struct TParticleEmitterGenerationPhysX : TParticleEmitterGeneration {

	float size;

	//Index for keep alineated the buffers 
	int index;

	//Bool for gravity
	bool gravity;

	TParticleEmitterGenerationPhysX(VParticles* the_particles, CHandle the_transform, float the_rate, float the_min_life_time, float the_max_life_time, float the_size, bool the_fill_initial, int the_limit, float the_burst_time, int the_burst_amount);
